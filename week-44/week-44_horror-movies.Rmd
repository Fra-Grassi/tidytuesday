...
- Do some sentiment analysis, to plot the sentiment of the movie "overview" across the years
...
Let's now do some sentiment analysis on the movies "overview". We're going to use the **"nrc"** lexicon, which categorizes words into ten positive and negative emotions. Of these ten, we're going to use 8, since the other two are general "positive" and "negative", and I feel they wouldn't be too informative.

## Tokenization

First of all, we must tokenize the "overview" column of our main dataset into individual words, which we'll then use for the sentiment analysis.  
...
token_df <- main_df %>% 
  drop_na(overview) %>% 
  select(title, overview, release_year) %>% 
